...
df <- data.frame(out_of_range_layer_1_concentration_groupby_result[order(-out_of_range_layer_1_concentration_groupby_result$ring_id),])

str(df)
write.csv(df,'out_of_range_layer1_count.csv')
```
