...
out_of_range_layer_1_setpoints <- out_of_range_rows[which(out_of_range_rows$Range_flag == "layer_1_setpoint"),]
...
out_of_range_wind_direction
```

## Check error values of layer_1_setpoints
```{r}
out_of_range_layer_1_setpoints <- data.table(out_of_range_layer_1_setpoints)
out_of_range_layer_1_setpoints_groupby_result <- out_of_range_layer_1_setpoints[, .N, by = .(layer_1_setpoint)]

out_of_range_layer_1_setpoints_groupby_result
```

## Check error values of layer_2_setpoints
```{r}
out_of_range_layer_2_setpoints <- data.table(out_of_range_layer_2_setpoints)
out_of_range_layer_2_setpoints_groupby_result <- out_of_range_layer_1_setpoints[, .N, by = .(layer_2_setpoint)]
